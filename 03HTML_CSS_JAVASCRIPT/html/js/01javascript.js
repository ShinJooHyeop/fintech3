...
// 웹브라우저 console에 id=title인 태그를 찾아서 출력
...
// 링크를 클릭해도 링크가 작동되지 않고 console.log만 작동되도록
// preventDefault()
...
btnLeft.addEventListener("click", (e) =>{
    e.preventDefault();
    num2--;
    console.log(`btnLeft를 클릭했을 떄 num2에 있는 값:${num2}`);
...
btnRight.addEventListener("click", (e) =>{
    e.preventDefault();
    num2++;
    console.log(`btnRight를 클릭했을 떄 num2에 있는 값:${num2}`);
    box2.style.transform = `rotate(${num2*deg}deg)`;
});